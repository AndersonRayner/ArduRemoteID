...
const Parameters::Param Parameters::params[] = {
    ...
    { "HOME_LAT",          Parameters::ParamType::FLOAT,  (const void*)&g.home_lat,         0, -90, 90 },
    { "HOME_LON",          Parameters::ParamType::FLOAT,  (const void*)&g.home_lon,         0, -180, 180 },
    { "HOME_ALT",          Parameters::ParamType::FLOAT,  (const void*)&g.home_alt,         0, -1000, 1000 },
