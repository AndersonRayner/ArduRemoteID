...
void Led::update(void)
{
    ...
    switch (state) {
    case LedState::ARM_OK:
        ledStrip.setPixelColor(0, ledStrip.Color(0, 5, 0));
        ledStrip.setPixelColor(0, ledStrip.Color(1, 5, 0)); //for db210pro, set the second LED to have the same output (for now)
        break;
